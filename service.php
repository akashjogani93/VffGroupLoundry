            ...
            <tbody>
                <?php 
                    ...
                    <td class="text-center">
                            <a href="service.php?edit=<?php echo $row['sid']?>"><button class="btn btn-sm btn-primary">Edit</button> </a>
                            <a onclick="del(<?php echo $row['sid']; ?>)"><button class="btn btn-sm btn-danger deletebutton" type="button">Delete</button></a></td> 
                    </tr>
                    <?php
                    }
                ?>    

...
if (isset($_POST['update'])) 
{
    ...
    $query = "UPDATE `staff` SET `fname`='$fname',`mname`='$mname',`lname`='$lname',`gen`='$gen',`adds`='$adds',`city`='$city',`state`='$state',`pin`='$pin',`mobile`='$mobile',`email`='$email',`branch`='$branch',`des`='$des' WHERE `id`='$id'";
    if($profile!='')
    {
